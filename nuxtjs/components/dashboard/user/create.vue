          ...
          <div class="row">
              ...
              <div class="col-md-4">
                  <div class="form-group"  v-if="lists_r">
                    ...
                    <multiselect v-model="list.role" :options="lists_r" :custom-label="rolesearch" placeholder="Select one" label="name" track-by="name"></multiselect>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="typo__label">Email</label>
                      <div class="input-group">
                          <input type="text"  v-validate="'email'" v-model="list.email" class="form-control" placeholder="email" name="email" aria-label="email...">
                      </div>
                </div>
                 ...
                 <div v-for="(address_name,key) in list.address" :key="key">
                    <div class="form-group">
                      <label class="typo__label">Address</label>
                          <div class="input-group">
                              <input type="text"   v-model="address_name.name" class="form-control" placeholder="Address" name="company name" aria-label="company name...">
                              <button v-if="key == 0" @click="addAddres()"  style="padding: 2px 7px; font-size: 13px;"  type="button" class="btn btn-info">
                                <i class="fa fa-plus"></i>
                              </button>
                              <button v-if="key != 0" @click="removeAddres(key)"  style="padding: 2px 7px; font-size: 13px;"  type="button" class="btn btn-info">
                 ...
                 <div v-for="(country_name,key) in list.country" :key="key">
                    <div class="form-group">
                      <label class="typo__label">Country</label>
                          <div class="input-group">
                              <input type="text"   v-model="country_name.name" class="form-control" placeholder="Country" name="company name" aria-label="company name...">
                              <button v-if="key == 0" @click="addCountry()"  style="padding: 2px 7px; font-size: 13px;"  type="button" class="btn btn-info">
                                <i class="fa fa-plus"></i>
                              </button>
                              <button v-if="key != 0" @click="removeCountry(key)"  style="padding: 2px 7px; font-size: 13px;"  type="button" class="btn btn-info">
                                <i class="fa fa-minus"></i>
                              </button>
                          </div>
                    </div>

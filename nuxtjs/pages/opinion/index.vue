					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="input-group input-group-alternative">
								...
								</div><input aria-label="Name..." v-model="list.name" class="form-control" placeholder="আপনার নাম লিখুন..." type="text">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<textarea class="form-control form-control-alternative" v-model="list.message" id="message" name="message" rows="6" placeholder="আপনার মতামত লিখুন.."></textarea>
						</div>

            ...
            <div>
              ...
              <div class="table-responsive mb-0">
                <table class="table table-pricing">
                  <tbody>
                    <tr class="bg-primary">
                      <td class="text-white" v-if="postType==1">
                          <b>Designation</b>
                      </td>
                      <td class="text-white" v-if="postType==2">
                          <b>Notice</b>
                      </td>
                      <td class="text-white" v-if="postType==3">
                          <b>Story Title</b>
                      </td>
                      <td class="text-white">
                          <b>Published at</b>
                      ...
                      <td class="text-white" v-if="postType==2 || postType==3">
                          <b>Expired at</b>
                      </td>
                      <td class="text-white">
                          <b>Action</b>
                    ...
                    <tr v-for="(list,key) in this.lists" v-bind:key="key">
                      ...
                      <td><span v-if="list.published_at">{{list.published_at.substr(0,10)}}</span><span v-else>Drafted</span></td>

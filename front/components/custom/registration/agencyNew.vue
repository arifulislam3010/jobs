    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group ">
                    <label for="inputPassword" class="labels"> যেসব চাকুরীতে লোক পাঠানো হয়<span class="required">*</span></label>
                    ...
                    <div>
                        <span v-if="errors.has('desired_job') && verify_status" class="validation_message"> চাকুরী প্রয়োজন</span>
                    </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group ">
                    <label for="inputPassword" class="labels"> যেসব দেশে লোক পাঠানো হয়<span class="required">*</span></label>

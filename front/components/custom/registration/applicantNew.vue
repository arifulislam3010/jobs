        ...
        <div class="col-md-6">
            <div class="side_form">
                <div style="width:100%;text-align:center;">
                    <br>
                    <button @click="goAgencyReg()" style="border-radius:0;" class="btn btn-primary">এজেন্সি রেজিস্ট্রেশন</button> <button @click="goAdminReg()" style="border-radius:0;" class="btn btn-primary">এডমিন রেজিস্ট্রেশন</button>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h4>আগ্রহী প্রার্থী রেজিস্ট্রেশন</h4>
                </div>
                <div class="col-md-12">

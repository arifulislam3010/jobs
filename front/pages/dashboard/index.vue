                ...
                <div class="col-md-4 col-xl-3">
                    <a href="#test">
                        <div  class="card bg-c-bb order-card">
                            <p style="font-size:15px;" class="m-b-0">মাইগ্রেট প্রার্থী<span  class="f-right"><i class="fas fa-clipboard-list"></i></span></p>
                          ...
                          <tr style="background:#888;color:#fff">
                              <td  colspan="4">
                                  <div class="col-md-12">
                                    <div class="row">
                                        <div style="width:35%;">
                                            <span style="font-size:20px;">মাইগ্রেট প্রার্থী: {{migration_count}}</span>
                                        </div>
                                        <div style="width:20%;">
                                            <multiselect
                                            v-model="country"

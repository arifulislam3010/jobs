              ...
              <div class="mb-0">
                <table class="table">
                  <tbody>
                    ...
                    <tr style="clear:both" v-for="(list,key) in this.lists" v-bind:key="key">
                      <td >{{list.headline}}</td>
                      <td style="color:#fff !important"><span v-if="list.published_at">{{list.published_at}}</span><span v-else>Drafted</span></td>

              ...
              <table class="table table-pricing" v-if="this.lists.data.length>0">
                <tbody>
                  <tr class="bg-primary text-white">
                    ...
                    <td>
                      <b>মাইগ্রেশন স্ট্যাটাস</b>
                    </td>
                    <td>
                      <b>মাইগ্রেশনের তারিখ</b>
                    </td>
                    <td>
                      <b>একশন</b>
                    </td>
                  ...
                  <tr v-for="(list,keya) in this.lists.data" v-bind:key="keya">
                    <td>
                      <label>
                        <b-form-checkbox :id="keya.toString()" v-model="usera" :value="list.id" unchecked-value></b-form-checkbox>
                      </label>
                    </td>
                    <td>{{list.name}}</td>
                    ...
                    <td class="text-center">
                      <button
                        ...
                        @click="openMigrateModalSingle(Object.assign({},list),keya)"
                        type="button"
                        class="btn btn-primary"
                      >
                      ...
                      <button
                        style="padding: 2px 7px; font-size: 13px;"
                        @click="openModal(Object.assign({},list),keya)"
                        type="button"
                        class="btn btn-primary"
                      >
...
export default {
  ...
  middleware: 'auth',
  layout: 'dashboard',
  components: { status, pagination,Multiselect },
  data() {
    return {
      modalOpen: false,
      districts:[],

        ...
        <div class="row ">
          ...
          <div style="width:20%">
            <select v-model="status"  class="form-control">
              ...
              <option value="3">সিলেক্ট তালিকা</option>
              <option value="4">মাইগ্রেট তালিকা</option>
                  ...
                  <tbody>
                    ...
                    <tr style="border-bottom:1px solid #f2f0f0;" v-for="(list,key) in lists2.data" :key="key">
                      ...
                      <td>
                        ...
                        <span v-else-if="list.status == 3">সিলেক্ট</span>
                        <span v-else-if="list.status == 4">মাইগ্রেট</span>
                      ...
                      <td style="position:absolute;">
                        ...
                        <b-nav-item-dropdown v-if="$auth.user.type == 3" text="প্রক্রিয়া" right>
                          ...
                          <b-dropdown-item @click="manageList(3,list.id,key)" href="#">সিলেক্ট তালিকায় যোগ করুন</b-dropdown-item>
                          <b-dropdown-item @click="manageList(4,list.id,key)" href="#">মাইগ্রেট তালিকায় যোগ করুন</b-dropdown-item>
                        </b-nav-item-dropdown>
                      </td>
                    </tr>
                  </tbody>

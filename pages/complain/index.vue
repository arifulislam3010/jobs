				...
				<!-- <form class="card bg-secondary p-3"> -->
					<div class="card-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control form-control-alternative" v-model="list.message" v-validate="'required'" name="message" rows="6" placeholder="আপনার অভিযোগ লিখুন"></textarea>
						</div>
						<p  v-if="errors.has('message') && check_status" class="validation_message">* অভিযোগ প্রয়োজন</p>
						<div v-if="form_errors.errors">

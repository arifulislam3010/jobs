<template>
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">ফিনান্সিয়াল অর্গানাইজেশন</h5>
        ...
        <div class="modal-body" style="overflow: auto;max-height: 350px;">
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                 <div class="form-group">
                  <label class="typo__label">মোবাইল নম্বর</label>
                      <div class="input-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="typo__label">রেজিস্ট্রেশন নম্বর</label>
                      <div class="input-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="typo__label">সার্ভিসের নাম</label>
                      <div class="input-group">
                          <input type="text"   v-model="list.service_name" class="form-control"  aria-label="nid...">
                      </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label class="typo__label">সার্ভিস ইউ আর এল</label>
                      <div class="input-group">
                          <input type="text"   v-model="list.service_url" class="form-control"  aria-label="nid...">
                      </div>
                </div>
              </div>
            </div>

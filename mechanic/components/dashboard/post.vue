  ...
  <div
    ...
    :style="
      this.$parent.modalOpen
        ? 'display: block; overflow: scroll; padding-right: 17px;'
        : ''
    "
    tabindex="-1"
    role="dialog"
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h5 v-if="type == 1" class="modal-title">
            <span v-if="edit">নিয়োগ বিজ্ঞপ্তি</span
            ><span v-else>নতুন নিয়োগ বিজ্ঞপ্তি</span>
          </h5>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            >
              ...
              <span class="alert-inner--text"
                ...
                {{ $store.state.admin.user.role.errors.error }}</span
              >
              <button
                type="button"
                class="close"
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label class="typo__label"
                  >শিরোনাম <span class="required">*</span></label
                >
                <div class="input-group">
                  <input
                    type="text"
                    v-validate="'required'"
                    v-model="list.headline"
                    class="form-control"
                    placeholder="শিরোনাম"
                    name="headline"
                    aria-label="Name..."
              ...
              <p
                v-if="errors.has('headline') && check"
            ...
            <div class="col-md-12" v-if="type == 2">
              ...
              <p v-if="errors.has('content')" class="validation_message">
                * {{ errors.first('content') }}
              </p>
              <div
                v-if="
                  $store.state.admin.post.errors.errors &&
                    $store.state.admin.post.errors.errors.content != 'undefined'
                "
              >
                <p
                  v-for="(error, k) in $store.state.admin.post.errors.errors
                    .content"
                  v-bind:key="'n' + k"
                  class="validation_message"
                >
            ...
            <div class="col-md-4" v-if="type == 1">
              <div class="form-group">
                <label class="typo__label">Salart</label>
                <div class="input-group">
                  <input
                    type="number"
                    step="0.5"
            ...
            <div class="col-md-4" v-if="type == 1">
              <div class="form-group">
                <label class="typo__label"
                  >ডেডলাইন <span class="required">*</span></label
                >
                <div class="input-group">
                  <input
                    type="date"
              ...
              <p
                v-if="errors.has('expired_at') && check"
                class="validation_message"
              >
                * ডেডলাইন প্রয়োজন
              </p>
            ...
            <div v-if="type == 1" class="col-md-4">
              <div class="form-group">
                <label class="typo__label">Seniority Level</label>
                <div class="input-group">
                  <multiselect
                    name="birth"
                    v-model="list.getSeniority"
                    placeholder="seniority level"
                    label="level"
                    track-by="id"
                    :options="getSeniority"
                  >
                  </multiselect>
                </div>
              </div>
            ...
            <div class="col-sm-4">
              ...
              <div
                v-else
                class="image_upload logo_upload"
        ...
        <div v-if="type == 3" class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" v-if="loader2">
            <i class="fa fa-cog fa-spin"></i> পাবলিশ
          </button>
          <button
            type="button"
        ...
        <div v-if="type == 1" class="modal-footer">
          ...
          <button type="button" class="btn btn-success" v-if="loader">
            <i class="fa fa-cog fa-spin"></i> পাবলিশ
          </button>
          <button
            type="button"
          ...
          <button type="button" class="btn btn-primary" v-if="loader2">
            <i class="fa fa-cog fa-spin"></i> ড্রাফট
          </button>
          <button type="button" class="btn btn-primary" v-else @click="draft()">
            ড্রাফট
          </button>
        </div>
        <div
...
export default {
  ...
  methods: {
    ...
    async getSeniorityLevel() {
      await this.$axios
        .get('/seniority-level')
        .then(response => {
          // console.log(response.data.data)
          this.getSeniority = response.data.data
        })
        .catch(error => {})
    },
    async getGender() {
    ...
    async save() {
      if (this.validateStatus == 1) {
        ...
        if (this.list.id == '') {
          await this.$store
            .dispatch('admin/post/add', this.list)
            .then(response => {
              this.loader = false
              this.loader2 = false
              this.$parent.modalOpen = false

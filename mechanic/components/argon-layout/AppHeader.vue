<template>
    <header class="header-global">
        <base-nav class="navbar-main  bg-danger" transparent type="" effect="light" expand>
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <base-dropdown tag="li" class="nav-item">
                    ...
                    <nuxt-link to="/dashboard/landing" class="dropdown-item">Landing</nuxt-link>
                    <nuxt-link to="/dashboard/profile" class="dropdown-item">Profile</nuxt-link>
                    <nuxt-link to="/dashboard/login" class="dropdown-item">Login</nuxt-link>
                    <nuxt-link to="/dashboard/register" class="dropdown-item">Register</nuxt-link>
                </base-dropdown>
            </ul>

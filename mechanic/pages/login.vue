      ...
      <div class="row justify-content-center">
        <div class="col-lg-5">
          <card
            ...
            class="border-0"
            style="background: #eee !important;color:#fff !important,opacity:0.5"
          >
            <template>
              <div class="text-center mb-4">
                <img width="auto" src="~/assets/icon/logo_custom.png" alt="" />
              </div>
              <div
                v-if="this.formError"
              ...
              >
                ...
                <span class="alert-inner--text"
                  ><strong>{{ this.formError.error }}</strong></span
                >
                <button
                  type="button"
              ...
              <form role="form">
                ...
                <div class="text-center">
                  <base-button
                    style="background-color:rgb(117,171,40);border:rgb(117,171,40);border-radius:0"
                    v-if="loader"
                    type="primary"
                    class="my-4"
                  >

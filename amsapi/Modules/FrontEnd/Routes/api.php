...
Route::prefix('frontend')->group(function () {
    ...
    Route::get('/post/details/{slug}', 'PostsController@post');
    Route::get('/top-post-owner', 'PostsController@topPostOwner');
    Route::get('/post/{id}', 'PostsController@details');
    Route::get('/area/{title}', 'PostsController@area');
    Route::get('/area', 'AreaController@area');
    Route::get('/subarea/{id}', 'AreaController@subarea');
    ...
    Route::get('/content/download/{id}', 'FrontEndController@contentDownload');
    Route::post('/contents', 'FrontEndController@contents');
    Route::post('/users', 'FrontEndController@user');
    Route::post('/total/users', 'FrontEndController@userTotal');
    Route::get('/user/{id}', 'FrontEndController@userDetails');
});

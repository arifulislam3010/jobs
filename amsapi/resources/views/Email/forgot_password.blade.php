...
<p>
	...
	<a href="http://localhost:8000/reset-password/{{$user->email}}/{{$code}}">Reset Password</a>
</p> -->
					...
					<tr style="color: rgb(78, 92, 110); font-size: 14px; line-height: 20px; margin-top: 20px;">
						<td colspan="2" style="padding-left:90px; padding-right:90px; text-align:center" valign="top">
							...
							<table>
								...
								<tr>
									<td bgcolor="#FFFFFF" style="text-align:center;" width="100%"><a href="http://api.immigration.org.bd/reset-password/{{$user->email}}/{{$code}}" style="font-weight:bold; text-decoration:none;"><span style="display:block; max-width:100% !important; width:93% !important; height:auto !important;background-color:rgb(117,171,40);padding-top:15px;padding-right:15px;padding-bottom:15px;padding-left:15px;border-radius:8px;color:#ffffff;font-size:24px;font-family:Arial, Helvetica, sans-serif;">পাসওয়ার্ড রিসেট করুন</span></a></td>
								</tr>
								<tr>
									<td height="20"></td>
								</tr><!-- <tr>

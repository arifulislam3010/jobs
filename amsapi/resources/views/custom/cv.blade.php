                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="experiance-single-block">
                                                ...
                                                <div class="experiance-single-block-item">
                                                    ...
                                                    <div>Joining Date
                                                        : {{date('d-m-Y', strtotime($experience->start))}}</div>
                                                    <div>Resign Date
                                                        : {{date('d-m-Y', strtotime($experience->end))}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="cv-single-content-block">
                                            <div class="cv-single-content-block-title">
                                                <h2>{{$edu->degree_name}}</h2>
                                            </div>
                                            <div class="cv-single-content-block-content">
                                                <p>
                                                    <span>Year: {{$edu->passing_year}}</span><br>
                                                    <span>Grade:{{$edu->grade}}</span><br>
                                                    <span>Group :{{$edu->subject}}</span><br>
                                                    <span>Board: {{$edu->board}}</span><br>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @foreach($trainings as $training)
                                    <div class="col-md-6">
                                        <div class="cv-single-content-block">
                                            ...
                                            <div class="cv-single-content-block-content">
                                                <p>
                                                    <span>Duration : {{$training->duration}} Month</span><span>Institute : {{$training->training->name}}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="personal-info cv-single-content-block-content">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:{{$contact->passport_issue_date}}</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="cv-single-content-block">
                                    ...
                                    <div class="addressInfo cv-single-content-block-content">
                                        <p>State <span>: {{$addressOne->division->division_name_bng}}</span></p>
                                        <p>Distrcit <span>: {{$addressOne->district->district_name_bng}}</span></p>
                                        <p>Thana <span>: {{$addressOne->subdistrict->upazila_name_eng}}   </span></p>
                                        <p>Area/Village <span>: {{$addressOne->union->union_name_eng}}</span></p>
                                        <p>House/Road <span>: {{$addressOne->street}}</span></p>
                                        <p>Post Code <span>: {{$addressOne->postoffice}}</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <div class="cv-single-content-block">
                                    ...
                                    <div class="addressInfo  cv-single-content-block-content">
                                        <p>State <span>: {{$addressTwo->division->division_name_bng}}</span></p>
                                        <p>Distrcit <span>: {{$addressTwo->district->district_name_bng}}</span></p>
                                        <p>Thana <span>: {{$addressTwo->subdistrict->upazila_name_eng}}   </span></p>
                                        <p>Area/Village <span>: {{$addressTwo->union->union_name_eng}}</span></p>
                                        <p>House/Road <span>: {{$addressTwo->street}}</span></p>
                                        <p>Post Code <span>: {{$addressTwo->postoffice}}</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>

<template>
  <div style="margin-top: 35px;" v-if="list">
        ...
        <div class="col-md-12 col-sm-12 row">
          ...
          <div class="col-md-7 col-sm-7">
            <div style="margin-left: 10px;">
              <p  style="color: rgb(149,27,129);font-size:25px;font-weight:bold">{{list.headline}}</p>
              <p
                class="on-mobile"
                style="font-size: 13px;height: 152px;overflow: hidden;margin-bottom: -44px;"
                v-html="list.content.substring(0, 250)"
              ></p>
              <br />
              <br />
              <nuxt-link to="/page/stories" class="see-more">
                <span style="font-size:18px;font-weight:bold;color:rgb(7,102,51);padding-bottom:10px;">আরো দেখুন...</span>
              </nuxt-link>
            </div>
          </div>
          <div class="col-md-1 col-sm-1">

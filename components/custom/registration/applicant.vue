<template>
  <div style="margin-top:30px;">
    <div class="row">
      ...
      <div class="col-md-5">
        <div class="form-group row">
          <label for="inputPassword" class="col-md-3 labels">কাঙ্খিত চাকুরী<span class="required">*</span></label>
          <div class="col-md-9 " @click="statusUpdate()">
            <treeselect style="margin-left:7%;width:98%;" name="desired_job" placeholder="কাঙ্খিত চাকুরী" v-validate="'required'"  v-model="job" :multiple="true" :options="desired_jobs" />
          </div>
          <div class="col-md-4"></div>
          <div class="col-md-8">
      ...
      <div class="col-md-5">
        <div class="form-group row">
          <label for="inputPassword" class="col-md-3 labels">কাঙ্খিত দেশ<span class="required">*</span></label>
          <div class="col-md-9 " @keyup="statusUpdate()">
            <treeselect style="margin-left:7%;width:98%;" name="country" v-validate="'required'" placeholder="কাঙ্খিত দেশ"  v-model="country" :multiple="true" :options="countries" />
          </div>
          <div class="col-md-4"></div>
          <div class="col-md-8">

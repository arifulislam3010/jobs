    ...
    <div>
        <div class="row">
            ...
            <div style="display:none;" v-if="images.length == 0" class="col-md-12 text-enter">
                <div  class="image_upload logo_upload col-md-2 pull-right" @click="$refs.files.click()">
...
export default {
    ...
    methods:{
        ...
        uploadMultipleImage(){
            ...
            this.$store.dispatch('admin/gallery/add2',formData).then(response=>{
                this.images = []
                this.urls = []
                this.names = []
                this.loader = false
        ...
        async getResults(page=1){
            ...
            await this.$store.dispatch('admin/gallery/get2',data) 
        },
        async deleteGallery(id,index){
            await this.$store.dispatch('admin/gallery/remove2',{id,index}) 
        }
    },
    mounted(){
        this.getResults();
